...
<html
  ...
  <head>
    ...
    <title>SIUBSI.Play | User Dashboard</title>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <!-- <li class="nav-item lh-1 me-3">
                      ...
                      <span style="margin-right: 5px;"><font color="#5C65FF">Halo User</font>, <?= $data['user']['nama_user']; ?></span>
          ...
          <div class="content-wrapper">
            <!-- Content -->
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard (User)/</span> <?= $titlepage; ?></h4>
                    ...
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">
                            Terdapat Daftar Game yang tersedia, Pengguna dapat menambahkan dan mengubah Info Game.
                          </p>
                          <a href="<?= base_url('game'); ?>" class="btn btn-outline-primary">Kunjungi Daftar Game</a>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">
                            Pada halaman ini, pengguna dapat melihat, mengubah, dan menambahkan panduan penggunaan game.
                          </p>
                          <a href="<?= base_url('game'); ?>" class="btn btn-outline-primary">Kunjungi Panduan Penggunaan Game</a>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">
                            Pada halaman ini, pengguna dapat melihat, mengubah, dan menambahkan catatan daftar pembaruan suatu game.
                          </p>
                          <a href="<?= base_url('updatelogs'); ?>" class="btn btn-outline-primary">Kunjungi Game Update Logs</a>
                        </div>
                      </div>
                    </div>
                </div>
