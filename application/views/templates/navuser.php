...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets/');?>css/game/gamecard.css">
    ...
    <title>SIUBSI.Play | Forum Komunitas Game Indonesia</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-colour" id="nav">
        <div class="container">
            <!-- <a class="navbar-brand text-white" href="<?=base_url('beranda')?>">SIUBSI.Play</a> -->
            <img src="<?= base_url('assets/'); ?>img/siubsiplay-logo3.png" class="navbar-brand" width="185" alt="">
